...
\begin{table}[H]
    ...
    肖像 & portrait\_path & varchar(255) & 非空 \\ \midrule
...
\begin{table}[H]
    ...
    \end{tabularx}
    \caption{家属关系数据元素表}
    \label{tab:family_relationship_elements}
\end{table}
...
\begin{table}[H]
    ...
    \end{tabularx}
    \caption{预约排班数据元素表}
    \label{tab:appointment_schedule_elements}
\end{table}
...
\begin{table}[H]
    ...
    医工号 & staff\_id & char(5) & 主键 \\ \bottomrule
    \end{tabularx}
    \caption{诊断数据元素表}
