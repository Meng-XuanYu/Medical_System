...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.8\textwidth]{images/doctor_dataflow.png}
    \caption{医护人员功能数据流图}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.8\textwidth]{images/admin_dataflow.png}
    \caption{管理人员功能数据流图}
\end{figure}
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.8\textwidth]{images/notification_dataflow.png}
    \caption{通知提醒功能数据流图}
\end{figure}
